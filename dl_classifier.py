...
class DeepLearningClassifier:
    def __init__(self, model_name='roberta-base', max_length=128, batch_size=32):
    ...
    def train_and_evaluate(self, x_train, x_test, y_train, y_test, log_file=None):
        def log(message):
            print(message)
            if log_file:
        ...
        for epoch in range(epochs):
            ...
            if accuracy > best_accuracy:
                ...
                best_report = report
                # Save best model
                checkpoint_path = f'checkpoints/dl_model_b{self.batch_size}_l{self.max_length}.pt'
                torch.save({
                    'epoch': epoch,
        ...
        log(f"Best Test Accuracy: {best_accuracy:.4f}")
        ...
        return best_accuracy, training_time, best_report, recall_neg, recall_pos, f1_neg, f1_pos
